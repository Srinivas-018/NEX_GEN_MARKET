...
<section class="search-form">
   <form action="" method="post">
      <input type="text" id="search_box" name="search_box" placeholder="Speak or Type your search . . ." maxlength="100" class="box" required>
      <button type="button" class="fas fa-microphone" onclick="startRecognition()"></button>
